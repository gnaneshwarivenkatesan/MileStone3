...
<body>
	<div>
		...
		<%
			List userdb = (List) request.getAttribute("userdb");
...
%>
					<td><div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<a href="/blockuser?id=<%=e.getRegCode()%>" class="btn btn-warning">Block</a>
...
<td><div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<a href="/Unblockuser?id=<%=e.getRegCode()%>" class="btn btn-warning">UnBlock</a>
